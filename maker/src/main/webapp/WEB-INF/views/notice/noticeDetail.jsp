...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="/resources/css/notice/noticeDetail.css?after">
<title>공지사항 수정</title>
<script
...
<body>
			...
			<div class="notice_content_main">
				<div class="form_section">
					...
					<div class="form_section_content">
						<input class="input_block" name="n_title" readonly="readonly"
							value="<c:out value='${noticeInfo.n_title}'></c:out>">
					</div>
				</div>
				...
				<div class="form_section">
					...
					<div class="form_section_content">
						<textarea class="input_block" name="n_comment" readonly="readonly"><c:out
								value='${noticeInfo.n_comment}' /></textarea>
					</div>
				</div>
				...
				<c:if test="${customer != null}">
					<div class="btn_section">
						<button id="cancelBtn" class="btn menu_btn">목 록</button>
	...
	<form id="moveForm" method="get">
		<input type="hidden" name="nno"
			value='<c:out value="${noticeInfo.nno}"/>'> <input
		...
		$("#deleteBtn")
				.on(
						...
						function(e) {
							...
							moveForm
									.append('<input type="hidden" name="nno" value="${noticeInfo.nno}">');
