...
<link href="/resources/css/ticketAllChk.css" rel="stylesheet"
	type="text/css">
<!-- Bootstrap -->
		...
		<div class="top-block top-inner container">
			<div class="top-block-content">
				...
				<div class="page-breadcrumbs">
					...
					<a class="content-link" href="ticketBooking">예매하기</a>
				</div>
			</div>
		</div>
	</section>
	<div id="wrapper">
		<div id="ticketCenter">
			<form action="./ticketSave" method="post">
				...
				<label for="movieName">영화</label> <select id="m_title"
					name="m_title">
					<option value="null">--영화를 선택해 주세요.--</option>
					<c:forEach var="movie" items="${movies}">
						<option value="${movie.m_title}">${movie.m_title}</option>
					</c:forEach>
				</select><br> <label for="m_time">시간</label> <input type="text"
					id="m_time" name="m_time" readonly><br> <label
					for="sno">좌석번호</label> <input type="text" id="sno" name="sno"
					readonly><br>
