...
public class TicketController {
	...
	public String ticketChk(@RequestParam String t_time, @RequestParam int sno, @RequestParam String m_title) {
	...
	@ResponseBody
	@GetMapping("/seatChk")
	public ResponseEntity<List<Integer>> seatChk(@RequestParam String t_time, @RequestParam String m_title) {
...
//    	String m_title = requestData.get("m_title");
	...
	public String getMovieTime(@RequestParam("sno") int sno, @RequestParam("cno") int cno,
			@RequestParam("t_time") String t_time, @RequestParam("m_title") String m_title) {
//    	System.out.println(t_time);
//        System.out.println(sno);
//        System.out.println(m_title);
//        System.out.println(Long.valueOf(cno));

		tSvc.register(new TicketVO(t_time, 10000, sno, Long.valueOf(mSvc.findMnoByTitle(m_title)), Long.valueOf(cno)));
