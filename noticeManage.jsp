...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="/resources/css/notice/noticeManage.css">
<title>공지사항 목록</title>
...
<body>
	<%@ include file="../includes/header.jsp"%>
		<div class="notice_content_wrap">
			<div class="notice_content_subject"><span>공지사항</span></div>
		            	...
		            	<table class="notice_table">
		                    ...
		                    <c:forEach items="${list}" var="list">
		                    	<tr>
		                    		...
		                    		<td><fmt:formatDate value="${list.n_reg}" pattern="yyyy-MM-dd HH:mm"/></td>
		                    	</tr>
		                    </c:forEach>
		            	</table>
	            	</c:if>
		            ...
		            <div class="search_wrap">
	    				<form id="searchForm" action="/notice/noticeManage" method="get">
	        				<div class="search_input">
	            				<input type="text" name="keyword" placeholder="제목을 입력하세요." value='<c:out value="${pageMaker.cri.keyword}"></c:out>'>
